...
export default function OrganizationId() {
    ...
    const reviewAnalyticsRouteHandler = (reviewId: any) => {
        router.push(`/admin/organization/review/${reviewId}?org=${filter.organizationId}`);
    }
                ...
                <div className="flex justify-center w-full h-full">
                    <div className="max-xl:w-full xl:w-10/12 2xl:w-4/6 space-y-4">
                        ...
                        <div className="grid lg:grid-cols-7 gap-4 h-full relative w-full py-4 px-2">
                            ...
                            {/*review feed start*/}
                            <div className="grow h-full lg:columns-3 lg:col-span-3 flex pb-4 overflow-auto" id={'list-org-items'}>
