...
.container input:checked ~ .mark:after {
  display: block;
            ...
            <label htmlFor={id} className={'flex items-center cursor-pointer container'}>
                {
                    props.position === 'left' && <label htmlFor={id} className="mr-2 text-sm font-medium text-gray-900 dark:text-white">
                        {props.label}
                    </label>
                }
                ...
                {
                    props.position === 'right' && <label htmlFor={id} className="ml-2 text-sm font-medium text-gray-900 dark:text-white">
                        {props.label}
                    </label>
                }
            </label>
